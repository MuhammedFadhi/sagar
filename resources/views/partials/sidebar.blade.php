<aside class="pe-app-sidebar" id="sidebar" x-show="loggedIn" x-cloak>
    ...
    <nav class="pe-app-sidebar-menu nav nav-pills" data-simplebar id="sidebar-simplebar">
        <ul class="pe-main-menu list-unstyled">
            <li class="pe-menu-title" x-show="loggedIn">
                Saudi HR System
            </li>
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/dashboard') }}" class="pe-nav-link" :class="{ 'active': page === 'dashboard' }">
            ...
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/employees') }}" class="pe-nav-link" :class="{ 'active': page === 'employees' }">
                    <i class="bi bi-people pe-nav-icon"></i>
                    <span class="pe-nav-content">Employee Management</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/expiries') }}" class="pe-nav-link" :class="{ 'active': page === 'expiries' }">
                    <i class="bi bi-file-earmark-text pe-nav-icon"></i>
                    <span class="pe-nav-content">Document Expiry</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/leaves') }}" class="pe-nav-link" :class="{ 'active': page === 'leaves' }">
                    <i class="bi bi-calendar-check pe-nav-icon"></i>
                    <span class="pe-nav-content">Leave Management</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/tickets') }}" class="pe-nav-link" :class="{ 'active': page === 'tickets' }">
                    <i class="bi bi-airplane pe-nav-icon"></i>
                    <span class="pe-nav-content">Flight Tickets</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/reports') }}" class="pe-nav-link" :class="{ 'active': page === 'reports' }">
                    <i class="bi bi-bar-chart pe-nav-icon"></i>
                    <span class="pe-nav-content">Reports</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn && userRole === 'admin'">
                <a href="{{ url('/users') }}" class="pe-nav-link" :class="{ 'active': page === 'users' }">
                    <i class="bi bi-person-gear pe-nav-icon"></i>
                    <span class="pe-nav-content">User Management</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn && userRole === 'admin'">
                <a href="{{ url('/notifications') }}" class="pe-nav-link" :class="{ 'active': page === 'notifications' }">
                    <i class="bi bi-bell pe-nav-icon"></i>
                    <span class="pe-nav-content">Notifications</span>
                    <span class="badge bg-danger rounded-pill sidebar-badge ms-1" x-show="stats.expiries && stats.expiries.total > 0" x-text="stats.expiries.total"></span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn && userRole === 'admin'">
                <a href="{{ url('/settings') }}" class="pe-nav-link" :class="{ 'active': page === 'settings' }">
                    <i class="bi bi-gear pe-nav-icon"></i>
                    <span class="pe-nav-content">Company Settings</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn && userRole === 'admin'">
                <a href="{{ url('/logs') }}" class="pe-nav-link" :class="{ 'active': page === 'logs' }">
                    <i class="bi bi-journal-text pe-nav-icon"></i>
                    <span class="pe-nav-content">Activity Logs</span>
                </a>
            </li>
            <li class="pe-slide" x-show="loggedIn">
                <a href="{{ url('/profile') }}" class="pe-nav-link" :class="{ 'active': page === 'profile' }">
