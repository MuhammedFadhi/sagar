<!-- Begin Header -->
<header class="app-header" id="appHeader" x-show="loggedIn" x-cloak>
    <div class="container-fluid w-100">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-shrink-0 d-flex align-items-center gap-1">
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block" x-show="loggedIn">
                    <button class="header-profile-btn btn gap-1 text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="header-btn btn position-relative">
                            <img :src="userAvatar || 'assets/images/avatar/avatar-10.jpg'" alt="Avatar Image" class="img-fluid rounded-circle" style="width: 32px; height: 32px; object-fit: cover;">
                        ...
                        <div class="d-none d-lg-block pe-2">
                            <span class="d-block mb-0 fs-13 fw-semibold" x-text="userName">Loading...</span>
                            <span class="d-block mb-0 fs-12 text-muted text-capitalize" x-text="userRole">User</span>
                        </div>
                    </button>
                    <div class="dropdown-menu dropdown-mega-sm header-dropdown-menu p-3">
                        <div class="border-bottom pb-2 mb-2 d-flex align-items-center gap-2">
                            <img :src="userAvatar || 'assets/images/avatar/avatar-10.jpg'" alt="Avatar Image" class="avatar-md rounded-circle" style="width: 48px; height: 48px; object-fit: cover;">
                            <div>
                                <a href="javascript:void(0)">
                                    <h6 class="mb-0 lh-base" x-text="userName">Loading...</h6>
                                </a>
                                <p class="mb-0 fs-13 text-muted" x-text="userEmail">Loading...</p>
                            </div>
                        </div>
                        <ul class="list-unstyled mb-1 border-bottom pb-1">
                            <li><a class="dropdown-item" href="javascript:void(0)" @click="page = 'profile'"><i class="bi bi-person me-1"></i> My Profile</a></li>
                            <li x-show="userRole === 'admin'"><a class="dropdown-item" href="javascript:void(0)" @click="page = 'settings'"><i class="bi bi-gear me-1"></i> Settings</a></li>
                        </ul>
                        <ul class="list-unstyled mb-0">
                            <li><a class="dropdown-item" href="javascript:void(0)" @click="logout"><i class="bi bi-box-arrow-right me-1"></i> Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
